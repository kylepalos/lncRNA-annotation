#!/bin/bash
touch methylation_mutant_library_type.txt
output_file="methylation_mutant_library_type.txt"

# Clear the output file if it exists
> "$output_file"

# Specify the directory with all of the salmon quant files
base_directory="/home/kpalos/new_arabidopsis_lncRNAs/salmon_files/methylation_mutant_quants"
